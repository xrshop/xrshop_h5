<template>
  <div class="change-phone">
    <TitleBar title="修改手机" canBack />
    <div class="list-box">
      <div class="item">
        <div class="left">当前手机号</div>
        <div class="right">
          <input type="text" placeholder="请输入当前手机号" maxlength="11">
        </div>
      </div>
      <div class="item">
      ...
      <div class="item">
        ...
        <div class="right">
          ...
          <div class="verify-but">获取验证码</div>
        </div>
      </div>
    </div>
