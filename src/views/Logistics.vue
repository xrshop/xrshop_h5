<template>
  <div class="logistics">
    <TitleBar title="物流详情" canBack />
    <div class="info">
      <div class="left">
        <div class="item">物流公司:</div>
        <div class="item">物流单号:</div>
      </div>
      <div class="right">
        <div class="item">顺丰快递</div>
        <div class="item">785692669416</div>
      </div>
    </div>
    <div class="details">
      <div class="item-box">
  ...
  data() {
    return {
      schedule: [
        ...
        {
          id: 3, status: 4, msg: '您的订单已由本人签收，感谢您在星然云电商商城购物，欢迎 您再次光临。', time: '2020-03-09 03:40:00', issign: true,
        },
      ],
    };
  },
